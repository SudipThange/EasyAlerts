...
class UserRegisterSerializer(serializers.ModelSerializer):
    """
    Handles user registration with validation for email, phone, and password.
    Creates a new user account with hashed password and unique credentials.
    """
...
class UserLoginSerializer(serializers.Serializer):
    """
    Handles user login authentication with email and password.
...
class UserEditSerializer(serializers.ModelSerializer):
    """
    Handles user profile updates including name, phone number, and password.
    Validates all changes and applies with proper security measures.
    """
...
class UserViewSerializer(serializers.ModelSerializer):
    """
    Read-only serializer for displaying user profile information.
    Safe for public responses without sensitive data exposure.
    """
...
class UserTokenResponseSerializer(serializers.Serializer):
    """
    Comprehensive token response serializer with user details.
    Used for login response to provide complete user information and tokens.
    """
